        ...
        <section class="section">
            ...
            <div class="section-body">
                <div class="card">
                    ...
                    <div class="card-body">
                        {{-- <div class="mb-3">
                            <a href="{{ route('mapel.show', 'pdf') }}" class="btn btn-sm px-3 btn-danger mr-1"
                                target="_blank"><i class="fas fa-file-pdf mr-2"></i>Pdf</a>
                            <a href="{{ route('mapel.show', 'excel') }}" class="btn btn-sm px-3 btn-info"
                                target="_blank"><i class="fas fa-file-excel mr-2"></i>Excel</a>
                        </div> --}}
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped" id="mapel-table" width="100%">
                                <thead>
                                    <tr>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            datatableCall('mapel-table', '{{ route('admin.mapel.index') }}', [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex'
                },
                {
            ...
            $("#saveData").submit(function(e) {
                ...
                let url = "{{ route('admin.mapel.store') }}";
                const data = new FormData(this);

                if (kode !== "") {
                    data.append("_method", "PUT");
                    url = `/admin/mapel/${kode}`;
                }

                const successCallback = function(response) {
                    setButtonLoadingState("#saveData .btn.btn-success", false);
                    handleSuccess(response, "mapel-table", "createModal");
                };
