...
class BeritaController extends Controller
{
            ...
            if ($request->mode == "datatable") {
                return DataTables::of($beritas)
                    ...
                    ->addColumn('image', function ($berita) {
                        $imagePath = asset('storage/img/berita/' . $berita->gambar);
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('gambar')) {
            ...
            $request->file('gambar')->storeAs('img/berita/', $image, 'public');
        }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return $this->successResponse($berita, 'Data Berita Diubah!');
    }
